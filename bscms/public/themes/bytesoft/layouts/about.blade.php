...
<main id="main" class="main-pages">
    ...
    {{--<div class="module-header">--}}
    {{--<h2 class="title" data-aos="fade-down" data-aos-delay="0">DỊCH VỤ - BYTESOFT</h2>--}}
    {{--<p class="desc" data-aos="fade-down" data-aos-delay="200">Với tiêu chí "Chất lượng hơn số--}}
    {{--lượng. ByteSoft luôn tạo ra những sản phẩm có giá trị cao nhất". <span>Đến với chúng tôi, khách hàng sẽ luôn được cung cấp những dịch vụ tốt nhất</span>--}}
    {{--</p>--}}
    {{--</div>--}}
    {{--<div class="module-content">--}}
    {{--<div class="bs-row row-sm-15">--}}
    ...
    {{--<div class="service-item" data-aos="fade-left" data-aos-delay="800">--}}
    {{--<div class="img">--}}
    {{--<img src="images/tu-van-chien-luoc-hover.svg" alt="Tu-van-chien-luoc"--}}
    {{--class="active__img">--}}
    {{--<img src="images/tu-van-chien-luoc.svg" alt="Tu-van-chien-luoc"--}}
    {{--class="base__img">--}}
    {{--</div>--}}
    {{--<div class="text">--}}
    {{--<h3 class="title">TƯ VẤN CHIẾN LƯỢC CNTT</h3>--}}
    {{--<p class="desc">Lorem ipsum dolor sit amet, ectetur adipiscing elit. Nullam--}}
    {{--eget</p>--}}
    {{--</div>--}}
    {{--<a href="#" class="link"></a>--}}
    {{--</div>--}}
    {{--</div>--}}
    {{--<div class="bs-col md-33-15 sm-50-15">--}}
    {{--<div class="service-item" data-aos="fade-down" data-aos-delay="600">--}}
    {{--<div class="img">--}}
    {{--<img src="images/oursourcing-hover.svg" alt="outsourcing"--}}
    {{--class="active__img">--}}
    {{--<img src="images/oursourcing.svg" alt="outsourcing" class="base__img">--}}
    {{--</div>--}}
    {{--<div class="text">--}}
    ...
    {{--<div class="img">--}}
    {{--<img src="images/bao-mat-hover.svg" alt="bao-mat-va-an-toan-thong-tin"--}}
    {{--class="active__img">--}}
    {{--<img src="images/bao-mat.svg" alt="bao-mat-va-an-toan-thong-tin"--}}
    {{--class="base__img">--}}
    {{--</div>--}}
    {{--<div class="text">--}}
    {{--<h3 class="title">BẢO MẬT VÀ AN TOÀN THÔNG TIN</h3>--}}
    {{--<p class="desc">Lorem ipsum dolor sit amet, ectetur adipiscing elit. Nullam--}}
    {{--eget</p>--}}
    {{--</div>--}}
    {{--<a href="#" class="link"></a>--}}
