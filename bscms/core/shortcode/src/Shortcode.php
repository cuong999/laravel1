...
namespace Bytesoft\Shortcode;

use Bytesoft\Shortcode\Compilers\ShortcodeCompiler;
...
class Shortcode
{
     ...
     * Shortcode compiler
     *
     * @var \Bytesoft\Shortcode\Compilers\ShortcodeCompiler
     */
    protected $compiler;
     ...
     * Constructor
     *
     * @param \Bytesoft\Shortcode\Compilers\ShortcodeCompiler $compiler
     * @author Asif Iqbal
     * @since 2.1
     */
     ...
     *
     * @return \Bytesoft\Shortcode\Shortcode
     * @author Asif Iqbal
     * @since 2.1
     */
