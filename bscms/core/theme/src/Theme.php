...
use Bytesoft\Theme\Exceptions\UnknownPartialFileException;
use Bytesoft\Theme\Exceptions\UnknownThemeException;
use Closure;
use Exception;
...
class Theme implements ThemeContract
{
     ...
     * Asset.
     *
     * @var \Bytesoft\Theme\Asset | AssetContainer
     */
    protected $asset;
     ...
     * @param \Bytesoft\Theme\Breadcrumb $breadcrumb
     ...
     *
     * @return \Bytesoft\Theme\Breadcrumb
     */
     ...
     *
     * @param  string $theme
     * @throws \Bytesoft\Theme\Exceptions\UnknownThemeException
     * @return Theme
     * @author Teepluss <admin@laravel.in.th>
     * @throws \Illuminate\Contracts\Filesystem\FileNotFoundException
     */
     ...
     * @param  string $view
     * @param  array $args
     * @throws \Bytesoft\Theme\Exceptions\UnknownPartialFileException
     * @return mixed
     * @author Teepluss <admin@laravel.in.th>
     * @throws \Illuminate\Contracts\Filesystem\FileNotFoundException
     */
     ...
     * @throws \Bytesoft\Theme\Exceptions\UnknownLayoutFileException
