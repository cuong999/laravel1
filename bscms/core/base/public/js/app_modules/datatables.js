...
(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function text(dt) {
            return '<i class="fa fa-file-excel"></i> ' + dt.i18n('buttons.excel', Bytesoft.languages.tables.excel);
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function text(dt) {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', Bytesoft.languages.tables.export) + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function text(dt) {
            return '<i class="fa fa-file-excel"></i> ' + dt.i18n('buttons.csv', Bytesoft.languages.tables.csv);
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: function text(dt) {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', Bytesoft.languages.tables.print);
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: function text(dt) {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', Bytesoft.languages.tables.reset);
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: function text(dt) {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', Bytesoft.languages.tables.reload);
        },
    ...
    $(document).ready(function () {
        if (typeof window.LaravelDataTables !== 'undefined') {
            ...
            $(document).find('.dataTables_filter input[type=search]').prop('placeholder', Bytesoft.languages.tables.filter.trim());
