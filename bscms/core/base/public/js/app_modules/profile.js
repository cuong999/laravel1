/**
 * Created by Bytesoft on 06/09/2015.
 */
    ...
    CropAvatar.prototype = {
        ...
        submit: function () {
            if (!this.$avatarSrc.val() && !this.$avatarInput.val()) {
                Bytesoft.showNotice('error', 'Please select image!', Bytesoft.languages.notices_msg.error);
                return false;
            }
        ...
        submitDone: function (data) {
            ...
            if (data && !data.error) {
                if (data.data) {
                    ...
                    Bytesoft.showNotice('success', data.message, Bytesoft.languages.notices_msg.success);
                } else {
                    Bytesoft.showNotice('error', data.message, Bytesoft.languages.notices_msg.error);
                }
            } else {
                Bytesoft.showNotice('error', 'Failed to response', Bytesoft.languages.notices_msg.error);
            }
        },

        submitFail: function (errors) {
            Bytesoft.handleError(errors);
        },
