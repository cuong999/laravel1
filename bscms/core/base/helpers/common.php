...
use Bytesoft\Base\Facades\AdminBarFacade;
use Bytesoft\Base\Facades\DashboardMenuFacade;
use Bytesoft\Base\Facades\PageTitleFacade;
use Bytesoft\Base\Supports\Editor;
...
if (!function_exists('admin_bar')) {
    /**
     * @return Bytesoft\Base\Supports\AdminBar
     */
    function admin_bar()
    {
...
if (!function_exists('dashboard_menu')) {
    /**
     * @return \Bytesoft\Base\Supports\DashboardMenu
     */
