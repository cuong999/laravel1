...
return [
     ...
     */
    'welcome'      => [
        'templateTitle' => 'Bytesoft CMS',
        'title'         => 'Bytesoft CMS',
        'message'       => 'Welcome to Bytesoft CMS. Before getting started, we need some information on the database. You will need to know the following items before proceeding.',
        'next'          => 'Let\'s go',
    ],
