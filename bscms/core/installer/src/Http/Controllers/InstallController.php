...
namespace Bytesoft\Installer\Http\Controllers;

use Artisan;
use Bytesoft\ACL\Models\User;
use Bytesoft\ACL\Repositories\Interfaces\UserInterface;
use Bytesoft\Installer\Events\EnvironmentSaved;
use Bytesoft\Installer\Events\InstallerFinished;
use Bytesoft\Installer\Helpers\DatabaseManager;
use Bytesoft\Installer\Helpers\EnvironmentManager;
use Bytesoft\Installer\Helpers\FinalInstallManager;
use Bytesoft\Installer\Helpers\PermissionsChecker;
use Bytesoft\Installer\Helpers\RequirementsChecker;
use Bytesoft\Installer\Http\Requests\SaveAccountRequest;
use Bytesoft\Installer\Http\Requests\SaveEnvironmentRequest;
...
class InstallController extends Controller
{
     ...
     *
     * @param \Bytesoft\Installer\Helpers\FinalInstallManager $finalInstall
     * @param \Bytesoft\Installer\Helpers\EnvironmentManager $environment
     * @return \Illuminate\Contracts\View\Factory|\Illuminate\View\View
     */
