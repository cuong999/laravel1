...
return [
    ...
    'allowed_mime_types' => env('RV_MEDIA_ALLOWED_MIME_TYPES', 'jpg,jpeg,png,gif,txt,docx,zip,mp3,bmp,csv,xls,xlsx,ppt,pptx,pdf,mp4,doc,svg'),
    'mime_types' => [
        'image' => [
            'image/png',
            'image/jpeg',
    ...
    'max_file_size_upload' => env('RV_MEDIA_MAX_FILE_SIZE_UPLOAD', 10 * 1024 * 1024), // Maximum size to upload
