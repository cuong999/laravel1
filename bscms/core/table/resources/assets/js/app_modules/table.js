(($, DataTable) => {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.excel', BytesoftVariables.languages.tables.excel);
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            return '<i class="fa fa-download"></i> ' + dt.i18n('buttons.export', BytesoftVariables.languages.tables.export) + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            return '<i class="fa fa-file-excel-o"></i> ' + dt.i18n('buttons.csv', BytesoftVariables.languages.tables.csv);
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return '<i class="fa fa-print"></i> ' + dt.i18n('buttons.print', BytesoftVariables.languages.tables.print);
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return '<i class="fa fa-undo"></i> ' + dt.i18n('buttons.reset', BytesoftVariables.languages.tables.reset);
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return '<i class="fas fa-sync"></i> ' + dt.i18n('buttons.reload', BytesoftVariables.languages.tables.reload);
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', (event) => {
                ...
                if (ids.length === 0) {
                    Bytesoft.showNotice('error', 'Please select at least one record to perform this action!');
                    return false;
                }
