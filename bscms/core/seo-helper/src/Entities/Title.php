...
use Bytesoft\SeoHelper\Exceptions\InvalidArgumentException;

/**
 * Class     Title
 *
 * @package  Bytesoft\SeoHelper\Entities
 */
class Title implements TitleContract
{
     ...
     * @param  string $title
     *
     * @return \Bytesoft\SeoHelper\Entities\Title
     * @author ARCANEDEV
     */
     ...
     * @param  int $max
     *
     * @throws \Bytesoft\SeoHelper\Exceptions\InvalidArgumentException
     * @author ARCANEDEV
     */
