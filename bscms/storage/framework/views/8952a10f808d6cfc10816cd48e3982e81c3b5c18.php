                                    ...
                                    <div class="blog-item">
                                        <div class="content">
                                            ...
                                            <div class="text">
                                                ...
                                                <a href="<?php echo e(route('public.single', $post->slug)); ?>"
                                                   class="link"><?php echo e(__('Xem thêm')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="bs-row bs-row-md15">
                            ...
                            <div class="bs-col md-100-15 sm-50-15">
                                <div class="sidebar recruitment">
                                    ...
                                    <div class="content">
                                        <?php $__currentLoopData = get_all_jobs(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="sidebar-item">
                                                <div class="bs-row bs-row-tn5">
                                                    <div class="bs-col tn-40-5">
                                                        <div class="img">
                                                            <div class="ImagesFrame">
                                                                <a href="<?php echo e($jobs->slug); ?>" class="ImagesFrameCrop0">
                                                                    <img src="<?php echo e(get_object_image($jobs->image, 'thumb')); ?>"
                                                                         alt="<?php echo e($jobs->name); ?>">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="bs-col tn-60-5">
                                                        <div class="text">
                                                            <h4 class="title"><a
                                                                        href="<?php echo e($jobs->slug); ?>"><?php echo e($jobs->name); ?></a>
                                                            </h4>
                                                            <p class="desc"><?php echo e(date_from_database($jobs->created_at,'d,m,Y')); ?></p>
                                                            <p class="desc"><?php echo e(trans('plugins.blog::posts.post_by')); ?> <?php echo e($jobs->user->getFullName()); ?></p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="bs-col md-100-15 sm-50-15">
                                <div class="tag">
                                    <div class="head">
                                        <h3 class="title"><?php echo e(__("Thẻ")); ?></h3>
                                    </div>
                                    <div class="content">
                                        <div class="bs-row bs-row-tn5">
