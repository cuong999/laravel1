<div style="height: 34px;">
    ...
    <?php if(isset($attributes['with-short-code']) && $attributes['with-short-code'] == true): ?>
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <?php $__currentLoopData = $shortcodes = shortcode()->getAll(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(array_get($item, 'admin_config') != null): ?>
                            <li data-html="<?php echo e(array_get($item, 'admin_config')); ?>">
