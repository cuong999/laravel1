                                    ...
                                    <div class="blog-item">
                                        <div class="content">
                                            ...
                                            <div class="text">
                                                ...
                                                <p class="time__desc"><span><?php echo e(__("Đăng bởi")); ?>

                                                        </span> <?php echo e($post->user->username); ?>

                                                    ,
                                                    <span><?php echo e(__("Trong")); ?></span> <a
                                                            href="<?php echo e(route('public.single', $category->slug)); ?>"> <?php echo e($category->name); ?></a>
                                                </p>
