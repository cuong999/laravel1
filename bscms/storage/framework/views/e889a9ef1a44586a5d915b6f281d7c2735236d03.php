<div id="edit-slug-box" <?php if(empty($value) && !$errors->has($name)): ?> class="hidden" <?php endif; ?>>
    ...
    <span id="sample-permalink">
        <a class="permalink" target="_blank" href="<?php echo e(str_replace('--slug--', $value, url($prefix . '/' . config('core.slug.general.pattern')))); ?>">
...
<div data-url="<?php echo e(route('slug.create')); ?>" data-view="<?php echo e(rtrim(str_replace('--slug--', '', url($prefix . '/' . config('core.slug.general.pattern'))), '/') . '/'); ?>" id="slug_id" data-id="<?php echo e($id); ?>"></div>
<input type="hidden" name="slug_id" value="<?php echo e($id); ?>">