...
namespace Bytesoft\Captcha\Utilities;

use Bytesoft\Captcha\Contracts\Utilities\AttributesContract;
use Bytesoft\Captcha\Exceptions\InvalidArgumentException;
...
class Attributes implements AttributesContract
{
     ...
     * @return array
     *
     * @throws \Bytesoft\Captcha\Exceptions\InvalidArgumentException
     * @author ARCANEDEV
     */
