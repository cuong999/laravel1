...
namespace Bytesoft\Captcha;

use Bytesoft\Captcha\Contracts\CaptchaContract;
use Bytesoft\Captcha\Contracts\Utilities\AttributesContract;
use Bytesoft\Captcha\Contracts\Utilities\RequestContract;
use Bytesoft\Captcha\Exceptions\ApiException;
use Bytesoft\Captcha\Utilities\Attributes;
use Bytesoft\Captcha\Utilities\Request;
...
class Captcha implements CaptchaContract
{
     ...
     * HTTP Request Client
     *
     * @var \Bytesoft\Captcha\Contracts\Utilities\RequestContract
     */
    protected $request;
     ...
     * Captcha Attributes
     *
     * @var \Bytesoft\Captcha\Contracts\Utilities\AttributesContract
     */
