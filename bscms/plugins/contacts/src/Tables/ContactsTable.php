...
namespace Bytesoft\Contacts\Tables;
...
class ContactsTable extends TableAbstract
{
     ...
     */
    public function __construct(DataTables $table, UrlGenerator $urlGenerator, ContactsInterface $contactsRepository)
    {
        $this->repository = $contactsRepository;
        $this->setOption('id', 'table-plugins-contacts');
    ...
    public function ajax()
    {
        ...
        return apply_filters(BASE_FILTER_GET_LIST_DATA, $data, CONTACTS_MODULE_SCREEN_NAME)
    ...
    public function query()
    {
        ...
        $query = $model->select(['contacts.id', 'contacts.name', 'contacts.created_at', 'contacts.status']);
        return $this->applyScopes(apply_filters(BASE_FILTER_TABLE_QUERY, $query, $model, CONTACTS_MODULE_SCREEN_NAME));
    }
    ...
    public function buttons()
    {
        ...
        return apply_filters(BASE_FILTER_TABLE_BUTTONS, $buttons, CONTACTS_MODULE_SCREEN_NAME);
    }
