...
use Bytesoft\Language\Facades\LanguageFacade;
use Bytesoft\Language\Http\Middleware\LocaleSessionRedirect;
use Bytesoft\Language\Http\Middleware\LocalizationRedirectFilter;
use Bytesoft\Language\Http\Middleware\LocalizationRoutes;
use Bytesoft\Language\Models\Language as LanguageModel;
use Bytesoft\Language\Models\LanguageMeta;
use Bytesoft\Language\Repositories\Caches\LanguageMetaCacheDecorator;
use Bytesoft\Language\Repositories\Eloquent\LanguageMetaRepository;
...
use Bytesoft\Language\Repositories\Caches\LanguageCacheDecorator;
use Bytesoft\Language\Repositories\Eloquent\LanguageRepository;
...
class LanguageServiceProvider extends ServiceProvider
{
    ...
    {
        if (in_array($screen, Language::screenUsingMultiLanguage()) &&
            !$model instanceof \Bytesoft\Language\Models\Language &&
