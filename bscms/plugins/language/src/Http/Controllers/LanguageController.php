...
class LanguageController extends BaseController
{
     ...
     * @param Request $request
     * @param BaseHttpResponse $response
     * @param AboutStore $settingStore
     * @return BaseHttpResponse
     * @author Bytesoft
     */
    public function postEditSettings(Request $request, BaseHttpResponse $response, AboutStore $settingStore)
    {
        $settingStore
    ...
    /**
     * @param $code
     * @param \Bytesoft\Language\LanguageManager $language
