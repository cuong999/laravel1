...
use Bytesoft\LogViewer\Contracts\LogViewer as LogViewerContract;
...
class LogViewer implements LogViewerContract
{
     ...
     *
     * @var \Bytesoft\LogViewer\Contracts\Utilities\Factory
     */
    protected $factory;
     ...
     *
     * @param  \Bytesoft\LogViewer\Contracts\Utilities\Factory $factory
     ...
     * @param  string $path
     *
     * @return \Bytesoft\LogViewer\LogViewer
     * @author ARCANEDEV
     */
